...
final class PlayerEspEntityRenderer extends Render<PlayerEspRenderEntity> {
    ...
    @Override public void doRender(PlayerEspRenderEntity entity,double x,double y,double z,float yaw,float partial){GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);GL11.glPushMatrix();try{controller.onRender(0);}finally{GL11.glPopMatrix();GL11.glPopAttrib();}}
